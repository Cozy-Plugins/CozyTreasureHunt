...
public class UnSpawnCommand implements CommandType {
    ...
    public @Nullable String getDescription() {
        return "Used to un-spawn all the treasure.";
    }
    ...
    public @Nullable CommandStatus onUser(@NotNull User user, @NotNull ConfigurationSection section, @NotNull CommandArguments arguments) {
        // Un-spawn the treasure.
        CozyTreasureHunt.unSpawnTreasure();

        // Message the user.
        user.sendMessage(section.getString("unspawned_treasure", "&7Attempted to un-spawn all the treasure."));
